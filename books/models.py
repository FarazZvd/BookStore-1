...
class Author(models.Model):
    ...
    book = models.ForeignKey('Book', on_delete=models.CASCADE, related_name="author_name", default='')
...
class Book(models.Model):
    book = models.ForeignKey('Category',on_delete=models.CASCADE, related_name="books",null=True,blank=True)
